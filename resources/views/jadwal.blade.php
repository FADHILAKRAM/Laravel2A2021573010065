...
<h1 class="text-success">Jadwal Yang Telah Di Booking</h1>
<form method="POST">
			<label class="text-success">PILIH TANGGAL</label>
			<input type="date" name="tanggal">
			<input type="submit" value="FILTER">
		</form>.
    <table class="table table-bordered bordered-success text-center text-success">
    <thead>
                              <tr>
