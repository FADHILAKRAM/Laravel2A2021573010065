...
<div class="col-lg-9 mt-2">
                <div class="card">
                    ...
                    <body>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d194.34498983623436!2d97.11986869895024!3d5.173795294770936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30478317e4973e89%3A0x15c5d5cb724a84d0!2sRahmat%20Rizki!5e1!3m2!1sid!2sid!4v1686497416140!5m2!1sid!2sid" width="800" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </body>
                    </html>
                    </div>
                </div>
            ...
            <!-- Footer -->
<div style=" margin-top:10px;" class="text-center link-success py-2">
<div class="container-lg">
    <footer class="py-5">
      <div class="row">
        <div class="col-6 col-md-3 mb-3">
          <h3>RENT CAR STATION</h3>
          <img src="img/321.png" style="width:300px;height:150px;">
        </div>

        <div class="col-6 col-md-3 mb-3">
          <h3>Sosmed</h3>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                </svg> _FDLRENTCAR12</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                </svg>FDLRENTCAR</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                  <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                </svg>FDL_RENTCAR_-_</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
        ...
        <div class="col-6 col-md-3 mb-3">
          <h3>Alamat</h3>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success">Paya Punteut, Kec. Muara Dua,Lhokseumawe, Aceh</a></li>
          </ul>
        </div>
        ...
        <div class="col-6 col-md-3 mb-3">
          <h3>About</h3>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 link-success">Kemana Pun Perginya Healingnya FDL RENTCAR Solusinya</a></li>
          </ul>
        </div>
      </div>
    </footer>
